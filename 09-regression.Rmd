...
# Les modèles linéaire hiérarchiques

Les modèles de panels en économies, ou multiniveaux en sociologie, sont caractérisés par le fait que les données sont un empilement de différents échantillons correspondant à une stratification.
...
$$y_{i}=\overline{\beta}+\beta_{1}Aptitude_{i}+\mu_{k}+\epsilon_{ik}
$$
