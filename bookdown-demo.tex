...
\NormalTok{df<-}\KeywordTok{readRDS}\NormalTok{(}\StringTok{"./data/last.rds"}\NormalTok{) }\OperatorTok{%>%}\KeywordTok{drop_na}\NormalTok{()}
\NormalTok{df}\OperatorTok{$}\NormalTok{Age<-}\KeywordTok{as.factor}\NormalTok{(df}\OperatorTok{$}\NormalTok{Age)}
\NormalTok{df}\OperatorTok{$}\NormalTok{Sexe<-}\KeywordTok{as.factor}\NormalTok{(df}\OperatorTok{$}\NormalTok{Sexe)}
\NormalTok{df}\OperatorTok{$}\NormalTok{Education<-}\KeywordTok{factor}\NormalTok{(df}\OperatorTok{$}\NormalTok{Education, }\DataTypeTok{ordered =} \OtherTok{FALSE}\NormalTok{ )}
\NormalTok{df}\OperatorTok{$}\NormalTok{Situation2<-}\KeywordTok{as.factor}\NormalTok{(df}\OperatorTok{$}\NormalTok{Situation2)}

\NormalTok{df}\OperatorTok{$}\NormalTok{Situation3<-}\KeywordTok{as.factor}\NormalTok{(}\KeywordTok{ifelse}\NormalTok{(df}\OperatorTok{$}\NormalTok{Situation}\OperatorTok{<}\DecValTok{5}\NormalTok{,}\StringTok{"degradation"}\NormalTok{,}\StringTok{" Amelioration"}\NormalTok{))}
\KeywordTok{table}\NormalTok{(df}\OperatorTok{$}\NormalTok{Situation3)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit <-}\KeywordTok{ctree}\NormalTok{(Situation3 }\OperatorTok{~}\StringTok{ }\NormalTok{Age}\OperatorTok{+}\NormalTok{Sexe}\OperatorTok{+}\NormalTok{Education, }\DataTypeTok{data=}\NormalTok{df)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pred <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(fit, df)}
\KeywordTok{library}\NormalTok{(caret)}
\NormalTok{cm =}\StringTok{ }\KeywordTok{confusionMatrix}\NormalTok{(df}\OperatorTok{$}\NormalTok{Situation3, pred)}
...
\CommentTok{#rules<-ct_rules(fit)}

\CommentTok{#rules %>% }
\CommentTok{#  kable() %>%}
\CommentTok{#  kable_styling(bootstrap_options = "striped", font_size = 10)}
\end{Highlighting}
\end{Shaded}
