...
Pour appliquer la méthode on va s’intéresser à l'échelle des valeurs de @schwartz_les_2006, qui sont mesurées dan différents pays au cours des différentes vagues de l'enquête European Social Survey. 
...
On reporte le lecteur au chapitre X de du [book NLP](https://benaventc.github.io/NLPBook/).
